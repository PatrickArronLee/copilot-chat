...
class CopilotApiClient {
    ...
    fun streamMessage(
        ...
        // Execute blocking OkHttp call directly in the flow — flowOn(IO) below
        // moves the entire flow block onto the IO dispatcher so emit() is safe.
    ...
    }.flowOn(Dispatchers.IO)  // run the entire flow block on IO — emit() is now safe
